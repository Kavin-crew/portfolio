    ...
    >
      ...
      >
        <div
          ...
          className="absolute flex justify-start items-start  rounded-2xl  shadow-[0_4px_8px_rgb(0_0_0/0.1)] hover:bg-zinc-50 hover:dark:bg-zinc-800/50 border border-white/10 group-hover/pin:border-white/20 transition duration-700 overflow-hidden"
        >
